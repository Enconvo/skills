...
function printUsage(cookiePath: string, profileDir: string): void {
  console.log(`Usage:
  npx -y bun \${SKILL_DIR}/scripts/main.ts --prompt "Hello"
  npx -y bun \${SKILL_DIR}/scripts/main.ts "Hello"
  npx -y bun \${SKILL_DIR}/scripts/main.ts --prompt "A cute cat" --image generated.png
  npx -y bun \${SKILL_DIR}/scripts/main.ts --promptfiles system.md content.md --image out.png

Multi-turn conversation (agent generates unique sessionId):
  npx -y bun \${SKILL_DIR}/scripts/main.ts "Remember 42" --sessionId abc123
  npx -y bun \${SKILL_DIR}/scripts/main.ts "What number?" --sessionId abc123
